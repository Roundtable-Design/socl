export default [
  {
    author: "Rev Dr Rowan Williams",
    picture:
      "https://images.prismic.io/socl-api/1ee449a0-40fe-4d95-aceb-be60894e4fee_rowan-williams.jpg?auto=compress,format",
    paragraphs: [
      ...
      'The proposed development will be a chance for Christians of all traditions to discover new openings for growth in contemplative maturity, and I hope and pray that these plans will come to fruition."',
    ],
    image: require("../assets/images/bowl.png"),
  },
  {
    author: "Fr Martin Laird OSA",
    picture:
      "https://images.prismic.io/socl-api/5918887f-2025-4078-929e-e4062f15bdcd_liard.jpg?auto=compress,format",
    paragraphs: [
